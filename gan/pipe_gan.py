...
def main():
  ...
  # Set model input
  # Just resize and normalize, no need for the random crops and flips that
  # were necessary to look at images during training.
  test_image_original = load_image(args.input)
  ...
  import numpy as np
  outimg = output()[0]
  plt.figure(num='Pipe Damage Prediction')
  #print(outimg.shape)
